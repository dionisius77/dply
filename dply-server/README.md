...
- docker tag dply-server dionisius77/dply-server && docker push dionisius77/dply-server
...
4. Access from dply client (https://github.com/dionisius77/dply/tree/main/dply)
```
