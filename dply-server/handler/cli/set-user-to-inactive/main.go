...
import (
	...
	password_svc "github.com/dionisius77/dply/dply-server/pkg/password"
...
func main() {
	...
	// Action
	err = user_uc.EditStatusToInactive(email)
	if err != nil {
		logrus.Errorln(err.Error())
		return
	}

	fmt.Println("User `" + email + "` has been set to inactive")
}
